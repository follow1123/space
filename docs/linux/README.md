...
* 第二种方式(指定ip)
  ...
  * 进行如下编辑
  ...
  ![](./img/QQ截图20210301162459.png)

  * 保存退出后重启网络服务`service network restart`或重启`reboot`即可
  * 如果使用虚拟机则还需要更改虚拟机的地址

  ![](./img/QQ截图20210301162955.png)
